...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Recommendation.position'
        db.add_column('recommendations_recommendation', 'position',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Recommendation.position'
        db.delete_column('recommendations_recommendation', 'position')
