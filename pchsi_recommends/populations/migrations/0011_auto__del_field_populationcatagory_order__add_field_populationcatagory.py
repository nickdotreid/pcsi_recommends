...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PopulationCatagory.order'
        db.delete_column('populations_populationcatagory', 'order')

        # Adding field 'PopulationCatagory.position'
        db.add_column('populations_populationcatagory', 'position',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PopulationCatagory.order'
        db.add_column('populations_populationcatagory', 'order',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1, db_index=True),
                      keep_default=False)

        # Deleting field 'PopulationCatagory.position'
        db.delete_column('populations_populationcatagory', 'position')
