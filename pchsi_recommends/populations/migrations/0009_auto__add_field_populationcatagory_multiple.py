...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PopulationCatagory.multiple'
        db.add_column('populations_populationcatagory', 'multiple',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PopulationCatagory.multiple'
        db.delete_column('populations_populationcatagory', 'multiple')
