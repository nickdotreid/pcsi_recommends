...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Note.object_id'
        db.alter_column('notes_note', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Note.object_id'
        db.alter_column('notes_note', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')(default=0))
