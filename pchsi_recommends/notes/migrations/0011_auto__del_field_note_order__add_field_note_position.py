...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('notes_note', 'order')

        # Adding field 'Note.position'
        db.add_column('notes_note', 'position',
    ...
    def backwards(self, orm):
        ...
        db.add_column('notes_note', 'order',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1, db_index=True),
                      keep_default=False)

        # Deleting field 'Note.position'
        db.delete_column('notes_note', 'position')
    ...
    models = {
        ...
        'notes.note': {
            'Meta': {'ordering': "['position']", 'object_name': 'Note'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'recommendations.recommendation': {
            'Meta': {'ordering': "['position']", 'object_name': 'Recommendation'},
